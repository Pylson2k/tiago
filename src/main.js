...
root.innerHTML = `
  <main class="site-shell">
    ...
    <section id="contato" class="contact-section section-yellow"><div class="contact-footer"><span>TIAGO GOMES FILADELFO</span><span>HIPERTROFIA / CONDICIONAMENTO / DEFINIÇÃO</span><a href="#top">voltar ao topo ↑</a></div></section>
  </main>
`;
