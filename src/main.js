// Estilo: Sinal de esforço — editorial esportivo brasileiro, preto carvão, off-white, amarelo de campo e laranja de transformação. A página prioriza a pessoa, as provas reais e o método do Tiago.
const assets = {
  portrait: "assets/tiago-portrait.webp",
  training: "assets/tiago-training.webp",
  community: "assets/futebol-comunidade.jpeg",
  street: "assets/futebol-rua.jpeg",
  win: "assets/futebol-conquista.jpeg",
  sunset: "assets/futebol-paisagem.jpeg",
  ...
  culture: "assets/estudo-cultura.jpeg",
...
root.innerHTML = `
  <main class="site-shell">
    <header class="site-header">
      ...
      <nav class="site-nav" aria-label="Navegação principal"><a href="#metodo">Método</a><a href="#resultados">Resultados</a><a href="#estudos">Estudos</a><a href="#contato">Contato</a></nav>
      <span class="header-index">[ 01—06 ]</span>
    </header>
    ...
    <section id="top" class="hero-section" aria-labelledby="hero-title">
      ...
      <div class="hero-content">
        ...
        <div class="hero-bottom js-hero-meta"><p>Hipertrofia, condicionamento e definição muscular com ciência, técnica e estratégia.</p><a class="arrow-link" href="#metodo">conheça o método <span>↘</span></a></div>
      </div>
      <div class="hero-side-note">01 / 04<br />cada repetição tem um motivo</div><div class="scroll-cue"><span>desça para evoluir</span><span class="scroll-line"></span></div>
    ...
    <section id="metodo" class="intro-section section-paper"><div class="section-marker dark js-reveal"><span>02</span><span>o método</span><span>↘</span></div><div class="intro-layout"><div><p class="micro-copy js-reveal">Não é uma ficha. É um plano de evolução.</p><h2 class="section-title dark-title js-reveal">Seu treino<br />não precisa<br />ser <em>genérico.</em></h2></div><div class="intro-copy js-reveal"><p class="lead-copy">Cada protocolo começa pelo aluno: biotipo, histórico, objetivo, restrições e o que ele precisa aprender para continuar evoluindo.</p><p>Tiago une biomecânica, periodização e conexão mente-músculo a técnicas como pré-exaustão, isometria, excêntrica controlada, bi-sets e progressão de carga.</p></div></div><a class="intro-action text-link js-reveal" href="#contato">quero conversar com o Tiago <span>↗</span></a><div class="intro-photo js-reveal"><img src="${assets.training}" alt="Tiago treinando com uma anilha em uma academia" loading="lazy" /><span>análise / ajuste / progressão</span></div></section>

    <section class="method-section section-dark"><div class="section-marker js-reveal"><span>03</span><span>como funciona</span><span>↘</span></div><div class="method-heading"><p class="micro-copy js-reveal">Três pilares para fazer cada repetição contar.</p><h2 class="section-title js-reveal">Resultado<br /><span>real</span> pede<br />método.</h2></div><div class="method-list"><article class="method-item js-reveal"><span class="method-number">01</span><h3>Análise<br />individual</h3><p>Biotipo, histórico, objetivo e restrições entram no plano desde o primeiro dia.</p><span class="method-arrow">↗</span></article><article class="method-item js-reveal"><span class="method-number">02</span><h3>Treino<br />inteligente</h3><p>Técnica, progressão e estímulo na medida certa — sem copiar a ficha de outra pessoa.</p><span class="method-arrow">↗</span></article><article class="method-item js-reveal"><span class="method-number">03</span><h3>Você<br />entende</h3><p>Educação para executar melhor, evitar lesões e assumir o controle da própria evolução.</p><span class="method-arrow">↗</span></article></div></section>
    ...
    <section id="contato" class="contact-section section-yellow"><div class="contact-top"><span>06</span><span>comece pelo seu objetivo</span><span>↗</span></div><div class="contact-main"><p class="micro-copy">Seu próximo treino pode começar com uma conversa.</p><h2>Vamos montar<br /><span>seu plano.</span></h2><a class="contact-link" href="https://www.instagram.com/reel/DIy91aMOAVY/?igsh=YmJja3lrOHRsOW4y" target="_blank" rel="noreferrer">falar com o Tiago no Instagram <span>↗</span></a></div><div class="contact-footer"><span>TIAGO GOMES FILADELFO</span><span>HIPERTROFIA / CONDICIONAMENTO / DEFINIÇÃO</span><a href="#top">voltar ao topo ↑</a></div></section>
  </main>
`;
