...
portrait: assets/tiago-portrait-editorial.png
facts:
  - label: Formação
    value: Graduação em Educação Física — em andamento
---

O texto público deve ser finalizado após confirmar instituição, período acadêmico,
certificações e serviços atualmente oferecidos.
